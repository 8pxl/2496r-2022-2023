...
void wp() 
{
    ...
    tsukasa.toggle();
    profiledDrive(8.5,100);
    tsukasa.toggle();
    pros::delay(400);
    profiledDrive(-8.5,100);
    spinTo(345,1100,oneeighty);
    cata::fire();
    pros::delay(300);
    spinTo(225, 900, ninety);
    tsukasa.toggle();
    intake::asyncPiston(299);
    profiledDrive(50, 200);
    // tsukasa.toggle();
    spinTo(327,800,ninety);
    cata::fire();
    pros::delay(800);
    profiledDrive(13,100);
    arcTurn(dtr(1), 252, 1200, -1, arc);
    profiledDrive(30, 200);
    spinTo(335, 900, fourfive);
