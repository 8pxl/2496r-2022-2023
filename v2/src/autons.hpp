...
void skills()
{
    ...
    chas::spinTo(190, 700);
    chas::drive(3300, 1300, 5);
    chas::spinTo(135, 700);
    chas::drive(-400,700,5);
    robot::cata.toggle();
    pros::delay(200);
    robot::plane.toggle();
}
...
void skillsReach()
{
    ...
    chas::velsUntilHeading(-30, -127,210, 4, 5000);
    robot::chass.spin(-70);
    pros::delay(1000);
    robot::chass.spinDiffy(-90, -40);
    pros::delay(400);
    robot::chass.spin(-30);
    pros::delay(1400);
    robot::chass.spin(-20);
...
fptr WP = wp; fptr SKILLS = skills; fptr NEARHALF = nearHalf; fptr FARHALF = farHalf; fptr FIVENEARHALF = fiveNearHalf; fptr DRIVER = driverAut; fptr SKILLSREACH = skillsReach;

std::vector<fptr> autons{WP,SKILLS, NEARHALF, FARHALF, FIVENEARHALF, DRIVER, SKILLSREACH};
std::vector<std::string> autonNames{"wp","skills","nearHalf", "farHalf", "fiveNearHalf", "driverAut", "skillsReach" };
