...
void nearHalf()
{
    ...
    chas::drive(-300, 500, 1);
    // robot::tsukasa.toggle();
    chas::spinTo(358.4, 600,smallTurn);
    pros::delay(250);
    ...
    robot::tsukasa.toggle();
    robot::intake.spin(127);
    chas::drive(760,640,5); 
    robot::tsukasa.toggle();

    pros::delay(680);
    chas::drive(-200,400,5);
    chas::spinTo(346.1, 1100,bigTurn);
    robot::intake.stop("B");
    // intake::waitIndex(3,5,true);
